      ...
      <div class="col-md-10  p-4 borber">
        <div class="row align-items-center mb-4">
          ...
          <div class="col text-end ">
            <a class="btn btn-success px-3" role="button" aria-disabled="true" href="register-clientes.php"><i
          ...
          <table class="table table-hover">
            <thead>
              ...
              <tr>
                <td><?=$cliente[0]?></td>
                <td><?=$cliente[1]?></td>
                <td><?= date ('d/m/Y', strtotime ($cliente[3])); ?></td>
                <td><?=$cliente[10]?></td>
                <td><?=$cliente[11]?></td>
                <td class="text-center">
                  <form action="process-clientes.php" method="POST">
                    <input type="hidden" class="form-control" id="acao" name="acao" value="SELECTID">
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$cliente[0]?>">
                ...
                <td class="text-center ">
                  <a class="dropdown-item" onclick="modalRemover(<?=$cliente[0]?>,'codDeletar')">
