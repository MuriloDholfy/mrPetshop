      ...
      <div class="col-md-10  p-4 borber">
        <div class="row align-items-center mb-4">
          ...
          <div class="col text-end ">
            <a class="btn btn-success px-3" role="button" aria-disabled="true" href="register-especie.php"><i
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th class="col-md-6 text-center">Descrição (Nome)</th>
              ...
              <tr>
                <td class = "text-center"><?=$especies[0]?></td>
                <td class = "text-center"><?=$especies[1]?></td>
                <td class="text-center">
                <form action="process-especie.php" method="POST">
                    <input type="hidden" class="form-control" id="acao" name="acao" value="SELECTID">
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$especies[0]?>">
                  ...
                  <td class="text-center ">
                  <a class="dropdown-item" onclick="modalRemover(<?=$especies[0]?>,'codDeletar')">
    ...
    <div class=" modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-danger text-white">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Excluir Especie</h1>
