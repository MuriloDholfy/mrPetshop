        ...
        <div class="card">
          <form method="POST" action="process-produto.php" enctype="multipart/form-data" class="needs-validation" novalidate>
            <div class="card-header">
              ...
              <input type="hidden" name="codProduto" id="codProduto" placeholder="Código Adm" value="<?=$cod_Produto?>">
              ...
              <div class=" col-md-10">
                <div class="row">
                  <div class="col-md-5 mb-3">
                    <label for="desc" class="col-form-label">Descrição do Produto (Nome):</label>
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" name="valorProduto" maxlength="50" id="valorProduto"
                      data-mask="R$ 000,00" data-mask-selectonfocus="true" value="<?=$valor_Produto?>" required>
                    <div class="invalid-feedback">
                      Valor Inválido
                    </div>
                  </div>
                  <div class="col-md-3">
                    ...
                    <select class="form-control" name="agendamentoProduto" id="agendamentoProduto" required>
                      <option value="obrigatorio" <?= $agendamento_Produto === 'obrigatorio' ? 'selected' : '' ?>>Obrigatório</option>
                      <option value="nao_necessario" <?= $agendamento_Produto === 'nao_necessario' ? 'selected' : 'selected' ?>>Não Necessário</option>
                    </select>
                ...
                <div class="row mt-5 ">
                  <div class="col-md-2">
                    <input type="file" id="imgProduto" name="imgProduto" accept="image/*" class="custom-file-input">
                  </div>
                  <div class=" text-end  col-md-10">
                  <a class=" btn btn-primary px-3" role="button" aria-disabled="true" href="produtos.php">Voltar</i></a>
