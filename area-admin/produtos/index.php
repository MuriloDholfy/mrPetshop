      ...
      <div class="col-md-10  p-4 borber">
        <div class="row align-items-center mb-4">
          ...
          <div class="col text-end ">
            <a class="btn btn-success px-3" role="button" aria-disabled="true" href="register-produtos.php"><i
          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th class="col-md-2">Agendamento</th>
              ...
              <tr>
                ...
                <td class="text-center ">
                  <a class="dropdown-item" onclick="modalRemover(<?=$produto[0]?>,'codDeletar')">
