        ...
        <div class=" row">
          <table class="table table-hover">
            <thead>
              ...
              <tr>
                <td class="text-center"><?=$vendaProduto[0]?></td>
                <td class="text-center"><?=$vendaProduto[1]?></td>
                <td class="text-center"><?=$vendaProduto[2]?></td>
                <td class="text-center"><?=$vendaProduto[3]?></td>
                <td class="text-center"><?=$vendaProduto[4]?></td>
                <td class="text-center">
                  <form action="process-vendaProduto.php" method="POST">
                    <input type="hidden" class="form-control" id="acao" name="acao" value="SELECTID">
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$vendaProduto[0]?>">
                ...
                <td class="text-center ">
                  <a class="dropdown-item" onclick="modalRemover(<?=$vendaProduto[0]?>,'codDeletar')">
